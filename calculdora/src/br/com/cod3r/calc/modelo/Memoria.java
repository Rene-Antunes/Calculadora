...
public class Memoria {
	...
	private enum TipoComando {
		ZERAR,ZERARDISPLAY,SINAL, NUMERO, DIV, MULT, SUB, SOMA, IGUAL, VIRGULA,PORCENTO;
	...
	public void processarComando(String texto) {
		...
		if (tipoComando == null) {
			...
			substituir =  false;
			ultimaOperacao = null;
		}else if (tipoComando == TipoComando.ZERARDISPLAY) {	
			textoAtual = "";
		...
		observadores.forEach(o -> o.valorAterado(getTextoAtual()));	
	}
	...
	private TipoComando detectarTipoComando(String texto) {
		...
		try {
			...
			//Quando não for númerico...
			
			if ("AC".equals(texto)) {
				return TipoComando.ZERAR;
				
			}else if ("CE".equals(texto)) {
				return TipoComando.ZERARDISPLAY;
